...
const V410_PATCH_NOTE = {
  ...
  general: [
    ...
    "무한 생존전은 완료 웨이브마다 누적한 코인과 경험치를 서버에서 함께 정산합니다.",
    "무한 생존전 증강은 매 3웨이브마다 실버·골드·플래티넘 순환으로 계속 등장하며, 같은 증강은 중첩됩니다.",
    "홈·도감에서 Convex 성장 데이터의 레벨과 현재·누적 경험치를 확인하며, 팀전 세 규칙을 게임 방식 찾기에서 바로 선택할 수 있습니다.",
    "홈의 현재 레벨 구간 경험치를 Convex 서버 성장 요약값으로 통일했습니다.",
    "도감 최종 스탯과 장착 갱신을 실제 전투의 아이템 효과 해석과 통일했습니다.",
    "영구 아이템의 체력·공격력·방어력·DEF 보호막 효과를 정수형으로 전환했습니다.",
    "모든 전투에서 1×부터 최대 2.5×까지 전투 속도를 즉시 변경할 수 있습니다.",
    "캐릭터 전용 사진 스킨은 Convex Storage에 원본을 저장하고, 카탈로그·장착 상태·로비·승리 연출·인게임 공에 동일하게 적용합니다.",
    "궤도 아이템은 점선 링 대신 실제 위성이 공전합니다. 수호 위성·파편 위성·노바 위성군·특이점 위성군 4종을 추가했습니다.",
    "캐릭터 전용 런 증강은 제거했으며, 모든 캐릭터는 동일한 공용 증강 풀을 사용합니다.",
    "영구 장비 풀을 35종으로 확장했습니다. 위성·파동·방벽·저격·기동·스킬 순환 빌드를 실제 효과로 조합할 수 있습니다.",
    "찬휘를 천마 콘셉트의 근거리 영역 장악형으로 리메이크했습니다. 마천결계의 범위 피해·둔화·마기 폭발은 PvP와 PvE에서 동일하게 적용됩니다.",
    "찬휘의 마천결계와 마기 폭발 반경을 각각 공 반지름의 5.2배·5.8배로 확장했습니다.",
  ],
};
