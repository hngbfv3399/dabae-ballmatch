...
export default defineSchema({
  ...
  persistentItemCatalog: defineTable({
    ...
    effects: v.object({
      ...
      orbitSatelliteCount: v.optional(v.number()),
      orbitSatelliteStyle: v.optional(v.union(v.literal("drone"), v.literal("shard"), v.literal("nova"), v.literal("singularity"))),
      orbitDamageBonus: v.optional(v.number()),
      orbitRadiusBonus: v.optional(v.number()),
      criticalDamageMultiplier: v.optional(v.number()),
      skillCastHealPercent: v.optional(v.number()),
