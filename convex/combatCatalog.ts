...
const CHARACTER_PROFILES: Seed[] = [
  ...
  { characterId: "chanhwi", archetype: "control", basicAttackType: "contact", maxHp: 175, attackPower: 15, speed: 1.25, defense: 8, luck: 15, attackInterval: 1.15, attackRangeRatio: .06, traits: traits("근거리 결계", "마기 폭발", "둔화·영역 장악"), isActive: true },
